...
export function useContract() {
    ...
    const [contract, setContract] = useState<OpenedContract<LingMine> | null>(null);
    ...
    useEffect(() => {
        ...
        const loadContract = async () => {
            try {
                ...
                const openedContract = client.open(contr) as OpenedContract<LingMine>;
    ...
    return {
        ...
        // @ts-ignore
        mint: () => contract?.sendTx(sender, toNano('0.8'), 1234n),
    };
}
